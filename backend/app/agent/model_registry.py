    ...
    def __init__(self):
        self._registry: Dict[str, ModelEntry] = {
            ...
            "vqa": ModelEntry(
                ...
                description="Person A LLaVA-OneVision Vision-Language Model for Remote Sensing VQA.",
            ),
            "captioning": ModelEntry(
                ...
                description="Person A LLaVA-OneVision Vision-Language Model for scene description.",
            ),
        }
